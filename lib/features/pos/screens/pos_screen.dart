...
class _PosScreenState extends State<PosScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        menuWidget: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                Get.toNamed(RouteHelper.getPosBarcodeRoute());
              },
            ),
      ...
      bottomNavigationBar: GetBuilder<PosController>(
        builder: (posController) {
            ...
            child: GetBuilder<StoreController>(
              builder: (storeController) {
                ...
                if (items.isEmpty) {
                  return Center(
                    child: Text(
                      'لا توجد منتجات مطابقة للبحث'.tr,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: PaginatedListWidget(
                      ...
                      onPaginate: (int? offset) async {
                        await storeController.getItemList(
