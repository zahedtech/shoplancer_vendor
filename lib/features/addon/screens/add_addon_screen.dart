...
class _AddAddonScreenState extends State<AddAddonScreen>
  ...
  void initState() {
    ...
    if (_update) {
      if (widget.addon!.addonCategoryId != null) {
        Get.find<AddonController>().setAddonCategory(
          widget.addon!.addonCategoryId,
        );
      }

      if (Get.find<StoreController>().vatTaxList != null &&
          Get.find<StoreController>().selectedVatTaxIdList.isEmpty &&
          widget.addon!.taxVatIds != null &&
          widget.addon!.taxVatIds!.isNotEmpty) {
        Get.find<StoreController>().preloadVatTax(
          vatTaxList: widget.addon!.taxVatIds!,
        );
      }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AddonController>(
      builder: (addonController) {
        return GetBuilder<StoreController>(
          builder: (storeController) {
            return Scaffold(
              appBar: CustomAppBarWidget(
                title: widget.addon != null
                    ? 'update_addon'.tr
                    : 'add_addons'.tr,
              ),
              body: Column(
                          ...
                          CustomCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'configure_the_basic_details_of_your_addon'
                                      .tr,
                          ...
                          CustomCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'specify_the_addons_price_and_assign_it_to_a_category'
                                      .tr,
                                  style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeSmall,
                                  ),
                                ...
                                CustomDropdownButton(
                                  ...
                                  dropdownMenuItems: addonController
                                      .addonCategoryList
                                      ?.map(
                                  ...
                                  selectedValue:
                                      addonController.addonCategoryName,
                                ),
                                SizedBox(
                                  height:
                                ...
                                Get.find<SplashController>()
                                    ...
                                    ? Column(
                                        ...
                                        children: [
                                          CustomDropdownButton(
                                            dropdownMenuItems: storeController
                                                .vatTaxList
                                                ?.map((e) {
                                                  bool isInVatTaxList =
                                                      storeController
                                          ...
                                          Wrap(
                                            children: List.generate(
                                              storeController
                                                  ...
                                                  .length,
                                              (index) {
                                                final vatTaxName = storeController
