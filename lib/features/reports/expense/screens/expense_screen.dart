...
import 'package:shoplancer_vendor/features/reports/expense/widgets/expense_card_widget.dart';
              ...
              Padding(
                ...
                child: Row(
                  children: [
                                    ...
                                    if (!expenseController.searchMode) {
                                      if (_searchController.text.isNotEmpty) {
                                        expenseController.setSearchText(
                                          offset: '1',
                                          from:
                                              Get.find<ReportController>().from,
                                          to: Get.find<ReportController>().to,
                    ...
                    InkWell(
                      onTap: () => expenseController.showDatePicker(
                        context,
                        isTaxReport: false,
                      ),
                      child: Container(
