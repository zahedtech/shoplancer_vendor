    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        if (Get.find<ReportController>().offset < pageSize) {
          Get.find<ReportController>().setOffset(
            Get.find<ReportController>().offset + 1,
          );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
        title: 'tax_report'.tr,
        menuWidget: InkWell(
          onTap: () => Get.find<ReportController>().showDatePicker(
            context,
            isTaxReport: true,
          ),
          child: Container(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '${'order_id'.tr} #${reportController.orders?[index].id}',
                                              style: robotoMedium.copyWith(
                                            ...
                                            Text(
                                              '${'tax'.tr}: ${PriceConverterHelper.convertPrice(reportController.orders?[index].totalTaxAmount)}',
