...
import 'package:shoplancer_vendor/features/subscription/widgets/change_subscription_plan_bottom_sheet.dart';
import 'package:shoplancer_vendor/features/subscription/widgets/subscription_details_widget.dart';
import 'package:shoplancer_vendor/features/subscription/widgets/transaction_widget.dart';
...
class _MySubscriptionScreenState extends State<MySubscriptionScreen>
  ...
  void initState() {
    ...
    if (Get.find<AuthController>().isLoggedIn()) {
      Get.find<SubscriptionController>().getProfile(
        Get.find<ProfileController>().profileModel,
      );
    } else {
      Get.find<SubscriptionController>().getProfile(
        Get.find<AuthController>().profileModel,
      );
    }
  ...
  Future<void> _loadTrialWidgetShow() async {
    await Get.find<ProfileController>().trialWidgetShow(
      route: RouteHelper.mySubscription,
    );
  }
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'best_for_new_businesses_preferring_pay_as_you_earn'
                                            .tr,
