...
import 'package:shoplancer_vendor/features/subscription/widgets/transaction_details_bottom_sheet.dart';
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        int pageSize = (Get.find<SubscriptionController>().pageSize! / 10)
            .ceil();
        if (Get.find<SubscriptionController>().offset < pageSize) {
          Get.find<SubscriptionController>().setOffset(
            Get.find<SubscriptionController>().offset + 1,
          );
                ...
                child: subscriptionController.transactions != null
                    ? subscriptionController.transactions!.isNotEmpty
                          ? ListView.builder(
                              ...
                              itemCount:
                                  subscriptionController.transactions?.length,
                              padding: const EdgeInsets.all(
