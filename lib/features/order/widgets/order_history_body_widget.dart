      ...
      return Get.find<ProfileController>().modulePermission!.order! ? Container(
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Row(
              children: List.generate(orderController.statusList.length, (index) {
                bool isSelected = orderController.historyIndex == index;
                String status = orderController.statusList[index];
                return Expanded(
                  child: InkWell(
                    onTap: () => orderController.setHistoryIndex(index),
                    child: Container(
                      ...
                      child: Text(
                        status.tr,
                        style: isSelected
                            ? robotoBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeSmall)
                            : robotoMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                      ),
                    ),
                  ),
                );
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildDateFilterChip(
                  ...
                  onTap: () {
                    String today = DateConverterHelper.dateTimeForCoupon(DateTime.now());
                ...
                _buildDateFilterChip(
                  ...
                  onTap: () {
                    String yesterday = DateConverterHelper.dateTimeForCoupon(
                      DateTime.now().subtract(const Duration(days: 1)),
                    );
                    orderController.setDateFilter(yesterday, yesterday, 2);
                  },
                ),
                _buildDateFilterChip(
                  context,
                  ...
                  onTap: () async {
                    ...
                    if (result != null) {
                      String from = DateConverterHelper.dateTimeForCoupon(result.start);
                      String to = DateConverterHelper.dateTimeForCoupon(result.end);
