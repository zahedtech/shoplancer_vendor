...
import 'package:shoplancer_vendor/common/widgets/dotted_divider.dart';
import 'package:shoplancer_vendor/features/language/controllers/language_controller.dart';
import 'package:shoplancer_vendor/features/order/widgets/price_widget.dart';
...
class InvoiceDialogWidget extends StatelessWidget {
  ...
  const InvoiceDialogWidget({
    ...
    /*required this.onPrint,*/ required this.isPrescriptionOrder,
    ...
    return OrientationBuilder(
      builder: (context, orientation) {
        double fixedSize =
            ...
            (orientation == Orientation.portrait ? 720 : 1400);
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            DateConverterHelper.dateTimeStringToMonthAndTime(
                              order!.createdAt!,
                            ),
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    (orderDetails![index].variation != null &&
                                                orderDetails![index]
                                                    .variation!
                                                    .isNotEmpty) ||
                                            (orderDetails![index]
                      ...
                      PriceWidget(
                        title:
                            '${'subtotal'.tr} ${taxIncluded ? 'vat_tax_inc'.tr : ''}',
                      ...
                      PriceWidget(
                        title: 'discount'.tr,
                        value: _priceDecimal(order!.storeDiscountAmount!),
                        fontSize: fontSize,
                      ),
                      const SizedBox(height: 5),
                      ...
                      taxIncluded || (order!.totalTaxAmount == 0)
                          ? const SizedBox()
                          : PriceWidget(
                              title: 'vat_tax'.tr,
                      ...
                      SizedBox(
                        height: taxIncluded || (order!.totalTaxAmount == 0)
                            ? 0
                            : 5,
                      ),
                      ...
                      (order!.extraPackagingAmount! > 0)
                          ...
                          : const SizedBox(),
                      SizedBox(
                        height: order!.extraPackagingAmount! > 0 ? 5 : 0,
                      ),
