...
import 'package:shoplancer_vendor/features/store/widgets/item_delete_dialog.dart';
import 'package:shoplancer_vendor/features/store/widgets/title_tag_widget.dart';
import 'package:shoplancer_vendor/features/store/widgets/variation_view_for_foood_widget.dart';
import 'package:shoplancer_vendor/features/store/widgets/variation_view_for_general_widget.dart';
...
class _PendingItemDetailsScreenState extends State<PendingItemDetailsScreen>
  ...
  void initState() {
    super.initState();
    Get.find<StoreController>().getPendingItemDetails(
      widget.id,
      canUpdate: false,
    );
              ...
              children: [
                ...
                Text(
                  storeController.item != null &&
                          storeController.item?.isRejected == 1
...
class EnglishLanguageItemTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        (item.isRejected == 1) && item.note != null && item.note!.isNotEmpty
            ? Container(
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return InformationTextWidget(
                                ...
                                value:
                                    '${item.taxData![index].taxRate.toString()} %',
                              );
                            },
                          ),
                        ],
