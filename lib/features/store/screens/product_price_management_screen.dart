        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              SizedBox(
                height: 40,
                child: storeController.categoryNameList != null
                    ? ListView.builder(
                ...
                child: storeController.itemList != null
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          double currentPrice =
                              _updatedPrices[item.id] ?? item.price ?? 0;
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  Item item = _editedItems.values.elementAt(
                                    index,
                                  );
                                  return Container(
  ...
  Future<void> _saveAllChanges(StoreController storeController) async {
    ...
    try {
      ...
      for (var entry in _updatedPrices.entries) {
        ...
        Item? item = storeController.itemList?.firstWhereOrNull(
