              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      width: variationStockControllers.isEmpty
                          ? Dimensions.paddingSizeDefault
                          : 0,
                    ),

                    variationStockControllers.isEmpty
                        ? Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: CustomTextFieldWidget(
                                            hintText: 'enter_stock'.tr,
                                            controller:
                                                variationStockControllers[index],
                                            inputType: TextInputType.number,
                                            isNumber: true,
    ...
    for (var variation in widget.item.variations!) {
      data.addAll({
        "price_${widget.item.variations!.indexOf(variation)}_${variation.type}":
            priceControllers[widget.item.variations!.indexOf(variation)].text
                .trim(),
      });
    }
    List<String> types = [];
    ...
    for (var variation in widget.item.variations!) {
      data.addAll({
        "stock_${widget.item.variations!.indexOf(variation)}_${variation.type}":
            variationStockControllers[widget.item.variations!.indexOf(
                  variation,
                )]
                .text
                .trim(),
