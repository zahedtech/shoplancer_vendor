...
class DailyTimeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var schedule in storeController.scheduleList!) {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: SizedBox(
              height: 60,
              child: storeController.isOpen24Hours
                  ? Row(
                      children: [
                        Container(
                                                  ...
                                                  Expanded(
                                                    child: CustomButtonWidget(
                                                      ...
                                                      onPressed: () {
                                                        ...
                                                        } else if (DateConverterHelper.convertTimeToDateTime(
                                                          openingTime!,
                                                        ).isAfter(
                                                          DateConverterHelper.convertTimeToDateTime(
                                                            openingTime!,
                                                          ),
                                                        )) {
                                                          showCustomSnackBar(
  ...
  bool _isUnderTime(String time, String startTime, String? endTime) {
    return DateConverterHelper.convertTimeToDateTime(
          time,
