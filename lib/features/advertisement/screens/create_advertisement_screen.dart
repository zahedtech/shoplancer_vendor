...
import 'package:shoplancer_vendor/features/advertisement/enums/ads_type.dart';
import 'package:shoplancer_vendor/features/advertisement/models/ads_details_model.dart';
import 'package:shoplancer_vendor/features/advertisement/widgets/create_advertisement_video_view_shimmer.dart';
import 'package:shoplancer_vendor/features/advertisement/widgets/custom_check_box.dart';
import 'package:shoplancer_vendor/features/advertisement/widgets/dotted_video_border.dart';
import 'package:shoplancer_vendor/features/advertisement/widgets/preview_profile_promotion_widget.dart';
import 'package:shoplancer_vendor/features/advertisement/widgets/preview_video_dialog_widget.dart';
...
class _CreateAdvertisementScreenState extends State<CreateAdvertisementScreen>
  ...
  void _editSetup() {
    ...
    Get.find<AdvertisementController>().initializeAdvertisementValues(
                              ...
                              Container(
                                ...
                                child: CustomDropdown<int>(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      adsController.selectedAdsType.tr,
                                    ),
                                  ),
                                ),
                              ),
                                ...
                                child: CustomTextFieldWidget(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      ...
                                      if (widget.adsDetailsModel != null) {
                                        bool isNotValidTimeRange = adsController
                                            .validateTimeRange(
  ...
  String modifyDateRange(DateTimeRange? dateTimeRange) {
    String firstDate = DateConverterHelper.stringToMDY(
      dateTimeRange?.start.toString() ?? "",
    );
    String lastDate = DateConverterHelper.stringToMDY(
