...
class RouteHelper {
  ...
  static String getPendingItemRoute({bool? fromNotification}) =>
      '$pendingItem?from_notification=${fromNotification.toString()}';
  ...
  static String getAddBannerRoute({
    required StoreBannerListModel? storeBannerListModel,
  }) {
    String? data;
    if (storeBannerListModel != null) {
      List<int> encoded = utf8.encode(
        jsonEncode(storeBannerListModel.toJson()),
      );
      data = base64Encode(encoded);
    }
  ...
  static String getReviewReplyRoute({
    ...
    bool storeReviewReplyStatus = false,
  }) {
  ...
  static String getSubscriptionSuccessRoute({
    ...
    int? packageId,
      ...
      '$subscriptionSuccess?flag=$status&from_subscription=$fromSubscription&store_id=$storeId&package_id=$packageId';
  static String getSubscriptionPaymentRoute({
    required int? storeId,
    required int? packageId,
  }) => '$subscriptionPayment?id=$storeId&package_id=$packageId';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      ...
      page: () {
        ...
        DeliveryManModel data = DeliveryManModel.fromJson(
          jsonDecode(utf8.decode(decode)),
        );
    ...
    GetPage(
      name: pendingItem,
      page: () => PendingItemScreen(
        fromNotification: Get.parameters['from_notification'] == 'true',
      ),
    ),
    GetPage(
      name: pendingItemDetails,
      page: () =>
          PendingItemDetailsScreen(id: int.parse(Get.parameters['id']!)),
    ),
    ...
    GetPage(
      ...
      page: () {
        ...
        if (Get.parameters['data'] != 'null') {
          ...
          storeBannerListModel = StoreBannerListModel.fromJson(
            jsonDecode(utf8.decode(decode)),
          );
        }
    ...
    GetPage(
      ...
      page: () => AnnouncementScreen(
        announcementStatus: int.parse(Get.parameters['announcement_status']!),
      ...
      page: () {
        ...
        return ReviewReplyScreen(
          ...
          storeReviewReplyStatus:
              Get.parameters['store_review_reply_status'] == 'true',
        );
      },
    ),
    GetPage(
    ...
    GetPage(
      ...
      page: () => SubscriptionPaymentScreen(
        storeId: int.parse(Get.parameters['id']!),
    ...
    GetPage(
      ...
      page: () => const AdvertisementListScreen(),
    ),
    GetPage(
